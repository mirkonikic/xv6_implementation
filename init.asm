...
strcmp(const char *p, const char *q)
{
 ...
 136:	75 18                	jne    150 <strcmp+0x30>
 138:	eb 2a                	jmp    164 <strcmp+0x44>
 ...
 21d:	31 db                	xor    %ebx,%ebx
{
 ...
 22d:	57                   	push   %edi
 22e:	6a 00                	push   $0x0
 230:	e8 36 01 00 00       	call   36b <read>
    if(cc < 1)
 ...
 243:	88 44 1a ff          	mov    %al,-0x1(%edx,%ebx,1)
    if(c == '\n' || c == '\r')
 247:	3c 0a                	cmp    $0xa,%al
 249:	74 25                	je     270 <gets+0x60>
 24b:	3c 0d                	cmp    $0xd,%al
 24d:	74 21                	je     270 <gets+0x60>
  for(i=0; i+1 < max; ){
 24f:	89 de                	mov    %ebx,%esi
 251:	83 c3 01             	add    $0x1,%ebx
 254:	3b 5d 0c             	cmp    0xc(%ebp),%ebx
 257:	7c cf                	jl     228 <gets+0x18>
      break;
  }
  buf[i] = '\0';
