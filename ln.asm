   ...
   e:	83 39 03             	cmpl   $0x3,(%ecx)
{
  ...
  42:	e8 7c 02 00 00       	call   2c3 <exit>
    printf(2, "link %s %s: failed\n", argv[1], argv[2]);
  47:	ff 73 08             	push   0x8(%ebx)
  4a:	ff 73 04             	push   0x4(%ebx)
...
strcmp(const char *p, const char *q)
{
  ...
  a4:	84 c0                	test   %al,%al
  a6:	75 18                	jne    c0 <strcmp+0x30>
  a8:	eb 2a                	jmp    d4 <strcmp+0x44>
 ...
 18d:	31 db                	xor    %ebx,%ebx
{
 ...
 19d:	57                   	push   %edi
 19e:	6a 00                	push   $0x0
 1a0:	e8 36 01 00 00       	call   2db <read>
    if(cc < 1)
 ...
 1b3:	88 44 1a ff          	mov    %al,-0x1(%edx,%ebx,1)
    if(c == '\n' || c == '\r')
