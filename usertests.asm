...
00000120 <iputtest>:
{
  ...
  printf(stdout, "iput test\n");
     ...
     12f:	ff 35 dc 5e 00 00    	push   0x5edc
  ...
  printf(stdout, "iput test ok\n");
     ...
     195:	ff 35 dc 5e 00 00    	push   0x5edc
    ...
    printf(stdout, "mkdir failed\n");
     ...
     1ac:	ff 35 dc 5e 00 00    	push   0x5edc
    ...
    printf(stdout, "chdir / failed\n");
     ...
     1c3:	ff 35 dc 5e 00 00    	push   0x5edc
    ...
    printf(stdout, "unlink ../iputdir failed\n");
     ...
     1da:	ff 35 dc 5e 00 00    	push   0x5edc
    ...
    printf(stdout, "chdir iputdir failed\n");
     ...
     1f1:	ff 35 dc 5e 00 00    	push   0x5edc
...
00000210 <exitiputtest>:
{
  ...
  printf(stdout, "exitiput test\n");
     ...
     21f:	ff 35 dc 5e 00 00    	push   0x5edc
  ...
  printf(stdout, "exitiput test ok\n");
     ...
     295:	ff 35 dc 5e 00 00    	push   0x5edc
     ...
     2b0:	ff 35 dc 5e 00 00    	push   0x5edc
    ...
    printf(stdout, "fork failed\n");
     ...
     2c7:	ff 35 dc 5e 00 00    	push   0x5edc
    ...
    exit();
     ...
     2de:	ff 35 dc 5e 00 00    	push   0x5edc
     ...
     2f5:	ff 35 dc 5e 00 00    	push   0x5edc
...
00000310 <openiputtest>:
{
  ...
  printf(stdout, "openiput test\n");
     ...
     31f:	ff 35 dc 5e 00 00    	push   0x5edc
  ...
  if(pid == 0){
    ...
    if(fd >= 0){
     ...
     36a:	ff 35 dc 5e 00 00    	push   0x5edc
  ...
  printf(stdout, "openiput test ok\n");
     ...
     3aa:	ff 35 dc 5e 00 00    	push   0x5edc
    ...
    printf(stdout, "fork failed\n");
     ...
     3cc:	ff 35 dc 5e 00 00    	push   0x5edc
    ...
    printf(stdout, "mkdir oidir failed\n");
     ...
     3e3:	ff 35 dc 5e 00 00    	push   0x5edc
    ...
    printf(stdout, "unlink failed\n");
     ...
     3fa:	ff 35 dc 5e 00 00    	push   0x5edc
...
00000410 <opentest>:
{
  ...
  printf(stdout, "open test\n");
     ...
     41f:	ff 35 dc 5e 00 00    	push   0x5edc
  ...
  printf(stdout, "open test ok\n");
     ...
     465:	ff 35 dc 5e 00 00    	push   0x5edc
    ...
    printf(stdout, "open echo failed!\n");
     ...
     47c:	ff 35 dc 5e 00 00    	push   0x5edc
    ...
    printf(stdout, "open doesnotexist succeeded!\n");
     ...
     493:	ff 35 dc 5e 00 00    	push   0x5edc
...
000004b0 <writetest>:
{
  ...
  printf(stdout, "small file test\n");
     ...
     4c1:	ff 35 dc 5e 00 00    	push   0x5edc
  ...
  for(i = 0; i < 100; i++){
    ...
    printf(stdout, "creat small succeeded; ok\n");
     ...
     4f4:	ff 35 dc 5e 00 00    	push   0x5edc
  ...
  printf(stdout, "writes ok\n");
     ...
     550:	ff 35 dc 5e 00 00    	push   0x5edc
  ...
  if(fd >= 0){
    ...
    printf(stdout, "open small succeeded ok\n");
     ...
     586:	ff 35 dc 5e 00 00    	push   0x5edc
  ...
  if(i == 2000){
    ...
    printf(stdout, "read succeeded ok\n");
     ...
     5ba:	ff 35 dc 5e 00 00    	push   0x5edc
  ...
  printf(stdout, "small file test ok\n");
     ...
     5e8:	ff 35 dc 5e 00 00    	push   0x5edc
     ...
     606:	ff 35 dc 5e 00 00    	push   0x5edc
     ...
     61f:	ff 35 dc 5e 00 00    	push   0x5edc
    ...
    printf(stdout, "error: open small failed!\n");
     ...
     636:	ff 35 dc 5e 00 00    	push   0x5edc
    ...
    printf(stdout, "read failed\n");
     ...
     64d:	ff 35 dc 5e 00 00    	push   0x5edc
    ...
    printf(stdout, "unlink small failed\n");
     ...
     664:	ff 35 dc 5e 00 00    	push   0x5edc
    ...
    printf(stdout, "error: creat small failed!\n");
     ...
     67b:	ff 35 dc 5e 00 00    	push   0x5edc
...
00000690 <writetest1>:
{
  ...
  printf(stdout, "big files test\n");
     ...
     6a1:	ff 35 dc 5e 00 00    	push   0x5edc
  ...
  printf(stdout, "big files ok\n");
     ...
     795:	ff 35 dc 5e 00 00    	push   0x5edc
     ...
     7b3:	ff 35 dc 5e 00 00    	push   0x5edc
     ...
     7ca:	ff 35 dc 5e 00 00    	push   0x5edc
     ...
     7e3:	ff 35 dc 5e 00 00    	push   0x5edc
     ...
     7fe:	ff 35 dc 5e 00 00    	push   0x5edc
    ...
    printf(stdout, "error: open big failed!\n");
     ...
     815:	ff 35 dc 5e 00 00    	push   0x5edc
    ...
    printf(stdout, "error: creat big failed!\n");
     ...
     82c:	ff 35 dc 5e 00 00    	push   0x5edc
    ...
    printf(stdout, "unlink big failed\n");
     ...
     843:	ff 35 dc 5e 00 00    	push   0x5edc
     ...
     868:	bb 30 00 00 00       	mov    $0x30,%ebx
{
  ...
  printf(stdout, "many creates, followed by unlink test\n");
     ...
     875:	ff 35 dc 5e 00 00    	push   0x5edc
  ...
  printf(stdout, "many creates, followed by unlink; ok\n");
     ...
     906:	ff 35 dc 5e 00 00    	push   0x5edc
...
00000920 <dirtest>:
{
  ...
  printf(stdout, "mkdir test\n");
     ...
     92f:	ff 35 dc 5e 00 00    	push   0x5edc
  ...
  printf(stdout, "mkdir test ok\n");
     ...
     995:	ff 35 dc 5e 00 00    	push   0x5edc
    ...
    printf(stdout, "mkdir failed\n");
     ...
     9ac:	ff 35 dc 5e 00 00    	push   0x5edc
    ...
    printf(stdout, "unlink dir0 failed\n");
     ...
     9c3:	ff 35 dc 5e 00 00    	push   0x5edc
    ...
    printf(stdout, "chdir .. failed\n");
     ...
     9da:	ff 35 dc 5e 00 00    	push   0x5edc
    ...
    printf(stdout, "chdir dir0 failed\n");
     ...
     9f1:	ff 35 dc 5e 00 00    	push   0x5edc
...
00000a10 <exectest>:
{
  ...
  printf(stdout, "exec test\n");
     ...
     a1f:	ff 35 dc 5e 00 00    	push   0x5edc
  ...
  if(exec("echo", echoargv) < 0){
    ...
    printf(stdout, "exec echo failed\n");
     ...
     a4b:	ff 35 dc 5e 00 00    	push   0x5edc
    ...
    2dc9:	31 f6                	xor    %esi,%esi
{
  ...
  printf(stdout, "sbrk test\n");
    ...
    2dd4:	ff 35 dc 5e 00 00    	push   0x5edc
  ...
  *lastaddr = 99;
  ...
  printf(stdout, "sbrk test OK\n");
    ...
    303a:	ff 35 dc 5e 00 00    	push   0x5edc
    ...
    30be:	ff 35 dc 5e 00 00    	push   0x5edc
    ...
    30d9:	ff 35 dc 5e 00 00    	push   0x5edc
    ...
    30f3:	ff 35 dc 5e 00 00    	push   0x5edc
    ...
    3112:	ff 35 dc 5e 00 00    	push   0x5edc
    ...
    3129:	ff 35 dc 5e 00 00    	push   0x5edc
    ...
    3140:	ff 35 dc 5e 00 00    	push   0x5edc
    ...
    3157:	ff 35 dc 5e 00 00    	push   0x5edc
    ...
    316e:	ff 35 dc 5e 00 00    	push   0x5edc
    ...
    319d:	ff 35 dc 5e 00 00    	push   0x5edc
    ...
    31b4:	ff 35 dc 5e 00 00    	push   0x5edc
    ...
    31cb:	ff 35 dc 5e 00 00    	push   0x5edc
    ...
    31e2:	ff 35 dc 5e 00 00    	push   0x5edc
    ...
    3218:	31 f6                	xor    %esi,%esi
{
  ...
  printf(stdout, "validate test\n");
    ...
    3223:	ff 35 dc 5e 00 00    	push   0x5edc
  ...
  printf(stdout, "validate ok\n");
    ...
    3291:	ff 35 dc 5e 00 00    	push   0x5edc
    ...
    32b3:	ff 35 dc 5e 00 00    	push   0x5edc
...
000032d0 <bsstest>:
{
  ...
  printf(stdout, "bss test\n");
    ...
    32df:	ff 35 dc 5e 00 00    	push   0x5edc
  ...
  printf(stdout, "bss test ok\n");
    ...
    330b:	ff 35 dc 5e 00 00    	push   0x5edc
    ...
    3323:	ff 35 dc 5e 00 00    	push   0x5edc
...
00003340 <bigargtest>:
{
  ...
  unlink("bigarg-ok");
    ...
    33ba:	ff 35 dc 5e 00 00    	push   0x5edc
    args[MAXARG-1] = 0;
    ...
    33e7:	ff 35 dc 5e 00 00    	push   0x5edc
    ...
    3417:	ff 35 dc 5e 00 00    	push   0x5edc
    ...
    342e:	ff 35 dc 5e 00 00    	push   0x5edc
...
strcmp(const char *p, const char *q)
{
  ...
  while(*p && *p == *q)
    ...
    3766:	75 18                	jne    3780 <strcmp+0x30>
    3768:	eb 2a                	jmp    3794 <strcmp+0x44>
    376a:	8d b6 00 00 00 00    	lea    0x0(%esi),%esi
    3770:	0f b6 41 01          	movzbl 0x1(%ecx),%eax
    p++, q++;
    3774:	83 c1 01             	add    $0x1,%ecx
    3777:	8d 5a 01             	lea    0x1(%edx),%ebx
  while(*p && *p == *q)
    377a:	84 c0                	test   %al,%al
    377c:	74 12                	je     3790 <strcmp+0x40>
    p++, q++;
    377e:	89 da                	mov    %ebx,%edx
  while(*p && *p == *q)
    3780:	0f b6 1a             	movzbl (%edx),%ebx
    3783:	38 c3                	cmp    %al,%bl
    3785:	74 e9                	je     3770 <strcmp+0x20>
  return (uchar)*p - (uchar)*q;
    3787:	29 d8                	sub    %ebx,%eax
}
    3789:	8b 5d fc             	mov    -0x4(%ebp),%ebx
    378c:	c9                   	leave  
    378d:	c3                   	ret    
    378e:	66 90                	xchg   %ax,%ax
  return (uchar)*p - (uchar)*q;
    3790:	0f b6 5a 01          	movzbl 0x1(%edx),%ebx
...
gets(char *buf, int max)
{
  ...
  for(i=0; i+1 < max; ){
    cc = read(0, &c, 1);
    3849:	8d 7d e7             	lea    -0x19(%ebp),%edi
{
    384c:	53                   	push   %ebx
  for(i=0; i+1 < max; ){
    384d:	31 db                	xor    %ebx,%ebx
{
    384f:	83 ec 1c             	sub    $0x1c,%esp
  for(i=0; i+1 < max; ){
    3852:	eb 2b                	jmp    387f <gets+0x3f>
    ...
    385d:	57                   	push   %edi
    385e:	6a 00                	push   $0x0
    3860:	e8 36 01 00 00       	call   399b <read>
    if(cc < 1)
    3865:	83 c4 10             	add    $0x10,%esp
    3868:	85 c0                	test   %eax,%eax
    386a:	7e 1d                	jle    3889 <gets+0x49>
      break;
    buf[i++] = c;
    386c:	0f b6 45 e7          	movzbl -0x19(%ebp),%eax
    3870:	8b 55 08             	mov    0x8(%ebp),%edx
    3873:	88 44 1a ff          	mov    %al,-0x1(%edx,%ebx,1)
    if(c == '\n' || c == '\r')
    3877:	3c 0a                	cmp    $0xa,%al
    3879:	74 25                	je     38a0 <gets+0x60>
    387b:	3c 0d                	cmp    $0xd,%al
    387d:	74 21                	je     38a0 <gets+0x60>
  for(i=0; i+1 < max; ){
    387f:	89 de                	mov    %ebx,%esi
    3881:	83 c3 01             	add    $0x1,%ebx
    3884:	3b 5d 0c             	cmp    0xc(%ebp),%ebx
    3887:	7c cf                	jl     3858 <gets+0x18>
      break;
  }
  buf[i] = '\0';
    3889:	8b 45 08             	mov    0x8(%ebp),%eax
    388c:	c6 04 30 00          	movb   $0x0,(%eax,%esi,1)
  return buf;
}
    3890:	8d 65 f4             	lea    -0xc(%ebp),%esp
    3893:	5b                   	pop    %ebx
    3894:	5e                   	pop    %esi
    3895:	5f                   	pop    %edi
    3896:	5d                   	pop    %ebp
  ...
  buf[i] = '\0';
    ...
    38b8:	8d b4 26 00 00 00 00 	lea    0x0(%esi,%eiz,1),%esi
    38bf:	90                   	nop
