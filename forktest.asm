  ...
  58:	31 db                	xor    %ebx,%ebx
{
  ...
  write(fd, s, strlen(s));
  5d:	68 34 04 00 00       	push   $0x434
  62:	e8 49 01 00 00       	call   1b0 <strlen>
  67:	83 c4 0c             	add    $0xc,%esp
  6a:	50                   	push   %eax
  6b:	68 34 04 00 00       	push   $0x434
  70:	6a 01                	push   $0x1
  ...
  e2:	68 3f 04 00 00       	push   $0x43f
  e7:	e8 c4 00 00 00       	call   1b0 <strlen>
  ec:	83 c4 0c             	add    $0xc,%esp
  ef:	50                   	push   %eax
  f0:	68 3f 04 00 00       	push   $0x43f
  f5:	6a 01                	push   $0x1
...
strcmp(const char *p, const char *q)
{
 ...
 176:	75 18                	jne    190 <strcmp+0x30>
 178:	eb 2a                	jmp    1a4 <strcmp+0x44>
 17a:	8d b6 00 00 00 00    	lea    0x0(%esi),%esi
 180:	0f b6 41 01          	movzbl 0x1(%ecx),%eax
    p++, q++;
 184:	83 c1 01             	add    $0x1,%ecx
 187:	8d 5a 01             	lea    0x1(%edx),%ebx
  while(*p && *p == *q)
 18a:	84 c0                	test   %al,%al
 18c:	74 12                	je     1a0 <strcmp+0x40>
    p++, q++;
 18e:	89 da                	mov    %ebx,%edx
  while(*p && *p == *q)
 190:	0f b6 1a             	movzbl (%edx),%ebx
 193:	38 c3                	cmp    %al,%bl
 ...
 19e:	66 90                	xchg   %ax,%ax
  return (uchar)*p - (uchar)*q;
 1a0:	0f b6 5a 01          	movzbl 0x1(%edx),%ebx
 ...
 25d:	31 db                	xor    %ebx,%ebx
{
 ...
 26d:	57                   	push   %edi
 26e:	6a 00                	push   $0x0
 270:	e8 36 01 00 00       	call   3ab <read>
    if(cc < 1)
 ...
 283:	88 44 1a ff          	mov    %al,-0x1(%edx,%ebx,1)
    if(c == '\n' || c == '\r')
